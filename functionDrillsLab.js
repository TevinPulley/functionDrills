...
greeting(name)
//! come back and simplify this one ( remove keywork )
////////////////// PROBLEM 5 ////////////////////
...
//! possible scope. look at lecture slides for possible scope examples.
...
// declaration
// expresion
//I put this in quotes so it would stop throwing errors.
...
/*
  ...
  Outside the function, create a variable called `oddChecker` and set it equal to your function invoked, making sure to pass
   in an argument.
*/

//!CODE HERE

function thatsOdd(numb){
  if (numb % 2 === 0){
    console.log('that is not odd')
  }
  else (console.log('that is odd indeed.'))
}
var oddChecker = thatsOdd(2)
...
let newContestantsArr = theEliminator(contestants, loser)

console.log(newContestantsArr)
...
var email = 'tevinpulley@gmail.com'
...
// let totalFrogs = chocFrogs(21)
let removedDecimal = Math.trunc(totalFrogs)
...
var arrayIsAscending = sample(sampleArray)
